        ...
        <div className="SignDiv">
            ...
            <main>
                <div className="row blocCcompte">
                    ...
                    <div className="formulaire col col-sm-8 col-md-8  col-lg-8 col-xl-6 bloc mt-5 mb-3">
                    ...
                    <Link href="/connexionRecruteur"><a className="center mb-5">Déjà inscrit ? connectez-vous</a></Link>
                </div>
            </main>
        </div>
    );
